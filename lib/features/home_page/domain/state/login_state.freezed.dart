...
abstract class $LoginStateCopyWith<$Res> {
  ...
  $Res call({LoginEntity loginEntity, bool error, bool connect, bool loading});
...
class _$_LoginState implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(loginEntity: $loginEntity, error: $error, connect: $connect, loading: $loading)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(loginEntity),
